...
const file_sk_opts_proto_rawDesc = "" +
	"\n" +
	"\rsk-opts.proto\"\xce\x06\n" +
	"\rsk_opts_entry\x12\x1b\n" +
	"\tso_sndbuf\x18\x01 \x02(\rR\bsoSndbuf\x12\x1b\n" +
	"\tso_rcvbuf\x18\x02 \x02(\rR\bsoRcvbuf\x12#\n" +
	"\x0eso_snd_tmo_sec\x18\x03 \x02(\x04R\vsoSndTmoSec\x12%\n" +
	"\x0fso_snd_tmo_usec\x18\x04 \x02(\x04R\fsoSndTmoUsec\x12#\n" +
	"\x0eso_rcv_tmo_sec\x18\x05 \x02(\x04R\vsoRcvTmoSec\x12%\n" +
	"\x0fso_rcv_tmo_usec\x18\x06 \x02(\x04R\fsoRcvTmoUsec\x12\x1c\n" +
	"\treuseaddr\x18\a \x01(\bR\treuseaddr\x12\x1f\n" +
	"\vso_priority\x18\b \x01(\rR\n" +
	"soPriority\x12\x1f\n" +
	"\vso_rcvlowat\x18\t \x01(\rR\n" +
	"soRcvlowat\x12\x17\n" +
	"\aso_mark\x18\n" +
	" \x01(\rR\x06soMark\x12\x1f\n" +
	"\vso_passcred\x18\v \x01(\bR\n" +
	"soPasscred\x12\x1d\n" +
	"\n" +
	"so_passsec\x18\f \x01(\bR\tsoPasssec\x12!\n" +
	"\fso_dontroute\x18\r \x01(\bR\vsoDontroute\x12\x1e\n" +
	"\vso_no_check\x18\x0e \x01(\bR\tsoNoCheck\x12 \n" +
	"\fso_bound_dev\x18\x0f \x01(\tR\n" +
	"soBoundDev\x12\x1b\n" +
	"\tso_filter\x18\x10 \x03(\x06R\bsoFilter\x12!\n" +
	"\fso_reuseport\x18\x11 \x01(\bR\vsoReuseport\x12!\n" +
	"\fso_broadcast\x18\x12 \x01(\bR\vsoBroadcast\x12!\n" +
	"\fso_keepalive\x18\x13 \x01(\bR\vsoKeepalive\x12\x1f\n" +
	"\vtcp_keepcnt\x18\x14 \x01(\rR\n" +
	"tcpKeepcnt\x12!\n" +
	"\ftcp_keepidle\x18\x15 \x01(\rR\vtcpKeepidle\x12#\n" +
	"\rtcp_keepintvl\x18\x16 \x01(\rR\ftcpKeepintvl\x12!\n" +
	"\fso_oobinline\x18\x17 \x01(\rR\vsoOobinline\x12\x1b\n" +
	"\tso_linger\x18\x18 \x01(\rR\bsoLinger\x12\x1e\n" +
	"\vso_buf_lock\x18\x19 \x01(\rR\tsoBufLock*6\n" +
	"\vsk_shutdown\x12\b\n" +
...
var (
	...
	file_sk_opts_proto_rawDescData []byte
)

func file_sk_opts_proto_rawDescGZIP() []byte {
	file_sk_opts_proto_rawDescOnce.Do(func() {
		file_sk_opts_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_sk_opts_proto_rawDesc), len(file_sk_opts_proto_rawDesc)))
	})
...
var file_sk_opts_proto_goTypes = []any{
...
func file_sk_opts_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_sk_opts_proto_rawDesc), len(file_sk_opts_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
